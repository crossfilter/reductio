...
module.exports = _dereq_("./crossfilter").crossfilter;

},{"./crossfilter":1}],3:[function(_dereq_,module,exports){
var reductio_avg = {
...
},{"./avg.js":3,"./count.js":4,"./sum.js":6,"./value-count.js":7}],6:[function(_dereq_,module,exports){
var reductio_sum = {
	add: function (a, prior) {
		return function (p, v) {
			if(prior) prior(p, v);
...
crossfilter = _dereq_('crossfilter');
